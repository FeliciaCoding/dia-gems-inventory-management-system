...
def render_item_card(i: Item):
    """
    Render a compact inventory card for a single item,
    showing basic details and a button that navigates
    to the appropriate item-specific details page.
    """
...
if user.get() is None:
    ...
    with conn.connect() as db:
        with items_cursor(import streamlit as st
from psycopg import sql
from streamlit_utils import db
from diamonds_ui.auth import user
from diamonds_ui.components.pagination import pagination_element
